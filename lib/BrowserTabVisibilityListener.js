...
var BrowserTabVisibilityListener = /** @class */ (function (_super) {
    ...
    function BrowserTabVisibilityListener() {
        ...
        if (!isEnableEnv)
            return _this;
        document.addEventListener(PageVisibilityEventType.CHANGE, _this.watchVisibilityEvent, false);
        window.addEventListener(UnloadEventType.BEFORE, _this.watchUnloadEvent, false);
        return _this;
    }
...
})(BrowserTabVisibilityEvent = exports.BrowserTabVisibilityEvent || (exports.BrowserTabVisibilityEvent = {}));
